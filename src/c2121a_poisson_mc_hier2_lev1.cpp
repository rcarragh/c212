...
//static const char *rcsId = "$Id: c2121a_poisson_mc_hier2_lev1.cpp,v 1.6 2018/10/03 15:40:28 clb13102 Exp clb13102 $";
...
c2121a_poisson_mc_hier2_lev1::c2121a_poisson_mc_hier2_lev1()
{
	//Rprintf("c2121a_poisson_mc_hier2_lev1::c2121a_poisson_mc_hier2_lev1: Default constructor\n");
	mu_theta = NULL;
	mu_gamma = NULL;
	sigma2_theta = NULL;
	sigma2_gamma = NULL;
...
c2121a_poisson_mc_hier2_lev1::c2121a_poisson_mc_hier2_lev1(SEXP sChains, SEXP sBurnin, SEXP sIter, SEXP sSim_Type,
					SEXP sMem_Model,
					...
					SEXP pY, SEXP pC, SEXP pT, SEXP ptheta, SEXP pgamma, SEXP pmu_gamma_0,
					SEXP ptau2_gamma_0, SEXP pmu_theta_0, SEXP ptau2_theta_0, SEXP palpha_gamma,
...
void c2121a_poisson_mc_hier2_lev1::clear()
{
	release();
	c2121a_poisson_mc_hier2_lev0::release();
}

void c2121a_poisson_mc_hier2_lev1::initL2Variables(SEXP pmu_gamma, SEXP pmu_theta, SEXP psigma2_gamma, SEXP psigma2_theta)
{
	int c = 0, b = 0;
...
void c2121a_poisson_mc_hier2_lev1::releaseL2Variables()
{
	int c = 0;
...
void c2121a_poisson_mc_hier2_lev1::initL2Samples()
{
	int c = 0, l = 0, b = 0;
...
void c2121a_poisson_mc_hier2_lev1::releaseL2Samples()
{
	int c = 0, b = 0;
...
c2121a_poisson_mc_hier2_lev1::~c2121a_poisson_mc_hier2_lev1()
{
	//Rprintf("c2121a_poisson_mc_hier2_lev1::c2121a_poisson_mc_hier2_lev1 - destructor\n");
	release();
}

void c2121a_poisson_mc_hier2_lev1::gibbs_sampler()
{
...
void c2121a_poisson_mc_hier2_lev1::simulate_MH()
{
	int i = 0;
...
void c2121a_poisson_mc_hier2_lev1::simulate_SLICE()
{
	int i = 0;
...
void c2121a_poisson_mc_hier2_lev1::sample_mu_gamma(int burnin, int iter)
{
	int c = 0, l = 0;
...
void c2121a_poisson_mc_hier2_lev1::sample_mu_theta(int burnin, int iter)
{
	int c = 0, l = 0;
	...
	for (c = 0; c < gChains; c++) {
		...
		for (b = 0; b < gNumBodySys[0]; b++) {
			...
			double denom = sigma2_theta[c][b] + ((double)nae)*tau2_theta_0;
...
void c2121a_poisson_mc_hier2_lev1::sample_sigma2_gamma(int burnin, int iter)
{
	int c = 0, l = 0;
...
void c2121a_poisson_mc_hier2_lev1::sample_sigma2_theta(int burnin, int iter)
{
	int c = 0, l = 0;
...
double c2121a_poisson_mc_hier2_lev1::log_f_gamma(int c, int i, int b, int j, double gamm)
{
...
void c2121a_poisson_mc_hier2_lev1::sample_gamma_MH(int burnin, int iter)
{
	int c = 0, l = 0;
...
void c2121a_poisson_mc_hier2_lev1::sample_gamma_SLICE(int burnin, int iter)
{
	int c = 0, i = 0;
	int K = 0, J = 0;
...
#if 0
					while (logy < log_f_gamma(c, i, b, j, l)) {
						l = l - gW_gamma[i][b][j];
					}

					while (logy < log_f_gamma(c, i, b, j, r)) {
						r = r + gW_gamma[i][b][j];
					}
#endif
					while (J > 0) {
...
double c2121a_poisson_mc_hier2_lev1::log_f_theta(int c, int i, int b, int j, double theta)
{
...
void c2121a_poisson_mc_hier2_lev1::sample_theta_MH(int burnin, int iter)
{
	int c = 0, l = 0;
...
void c2121a_poisson_mc_hier2_lev1::sample_theta_SLICE(int burnin, int iter)
{
	int c = 0, i = 0;
	int K = 0, J = 0;
...
#if 0
					while (logy < log_f_theta(c, i, b, j, l)) {
						l = l - gW_theta[i][b][j];
					}

					while (logy < log_f_theta(c, i, b, j, r)) {
						r = r + gW_theta[i][b][j];
					}
#endif
					while (J > 0) {
...
double c2121a_poisson_mc_hier2_lev1::cMIN(double a, double b)
{
	if (a < b) {
		return a;
	}
...
void c2121a_poisson_mc_hier2_lev1::release()
{
	releaseL2Variables();
...
SEXP c2121a_poisson_mc_hier2_lev1::getL2Samples(double*** &data)
{
...
SEXP c2121a_poisson_mc_hier2_lev1::getMuThetaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP c2121a_poisson_mc_hier2_lev1::getMuGammaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP c2121a_poisson_mc_hier2_lev1::getSigma2ThetaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP c2121a_poisson_mc_hier2_lev1::getSigma2GammaSamples()
{
	SEXP samples = R_NilValue;
...
void c2121a_poisson_mc_hier2_lev1::getMuThetaSamples(int *c, int *l, int* b, double* mu_theta)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void c2121a_poisson_mc_hier2_lev1::getMuGammaSamples(int *c, int *l, int* b, double* mu_gamma)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void c2121a_poisson_mc_hier2_lev1::getSigma2ThetaSamples(int *c, int *l, int* b, double* sigma2)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void c2121a_poisson_mc_hier2_lev1::getSigma2GammaSamples(int *c, int *l, int* b, double* sigma2)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
