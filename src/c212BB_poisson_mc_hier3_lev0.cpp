...
void c212BB_poisson_mc_hier3_lev0::clear()
{
	release();
	c2121a_poisson_mc_hier3_lev0::release();
	c2121a_poisson_mc_hier2_lev0::release();
...
void c212BB_poisson_mc_hier3_lev0::initL3Samples()
{
	int c = 0, l = 0;

	c2121a_poisson_mc_hier3_lev0::initL3Samples();
...
void c212BB_poisson_mc_hier3_lev0::releaseL3Samples()
{
	int c = 0, l = 0;

	c2121a_poisson_mc_hier3_lev0::releaseL3Samples();
...
void c212BB_poisson_mc_hier3_lev0::initL2Samples()
{
	int c = 0, l = 0, b = 0;

	c2121a_poisson_mc_hier3_lev0::initL2Samples();
...
void c212BB_poisson_mc_hier3_lev0::releaseL2Samples()
{
	int c = 0, l = 0, b = 0;

	c2121a_poisson_mc_hier3_lev0::releaseL2Samples();
...
void c212BB_poisson_mc_hier3_lev0::initL2Variables(SEXP pmu_gamma, SEXP pmu_theta, SEXP psigma2_gamma, SEXP psigma2_theta, SEXP pPi)
{
	int c = 0, l = 0, b = 0;

	c2121a_poisson_mc_hier3_lev0::initL2Variables(pmu_gamma, pmu_theta, psigma2_gamma, psigma2_theta);
...
void c212BB_poisson_mc_hier3_lev0::releaseL2Variables()
{
	int c = 0, l = 0; //, b = 0;

	c2121a_poisson_mc_hier3_lev0::releaseL2Variables();
...
void c212BB_poisson_mc_hier3_lev0::initL3Variables(SEXP pmu_gamma_0, SEXP ptau2_gamma_0,
					SEXP pmu_theta_0, SEXP ptau2_theta_0,
					SEXP palpha_pi, SEXP pbeta_pi)
{
	int c = 0, l = 0;

	c2121a_poisson_mc_hier3_lev0::initL3Variables(pmu_gamma_0, ptau2_gamma_0,
					pmu_theta_0, ptau2_theta_0);
...
void c212BB_poisson_mc_hier3_lev0::releaseL3Variables()
{
	int c = 0;

	c2121a_poisson_mc_hier3_lev0::releaseL3Variables();
...
void c212BB_poisson_mc_hier3_lev0::initL3Params(SEXP pmu_gamma_0_0, SEXP ptau2_gamma_0_0,
...
{
	c2121a_poisson_mc_hier3_lev0::initL3Params(pmu_gamma_0_0, ptau2_gamma_0_0,
					pmu_theta_0_0, ptau2_theta_0_0,
					palpha_gamma_0_0, pbeta_gamma_0_0,
					palpha_theta_0_0, pbeta_theta_0_0,
					palpha_gamma, pbeta_gamma,
...
void c212BB_poisson_mc_hier3_lev0::releasePMWeights()
{
	int l = 0, b = 0;
